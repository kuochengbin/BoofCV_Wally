...
public class ExampleTemplateMatching {
	...
	*//**
	...
	public static void main(String args[]) {
		...
		ImageFloat32 image = UtilImageIO.loadImage(directory + "WillyTest4.png", ImageFloat32.class);
		ImageFloat32 template1 = UtilImageIO.loadImage(directory + "Willy4PatternS.png", ImageFloat32.class);
		//ImageFloat32 template2 = UtilImageIO.loadImage(directory + "object2.png", ImageFloat32.class);
		//ImageFloat32 template3 = UtilImageIO.loadImage(directory + "object3.png", ImageFloat32.class);
		//ImageFloat32 template4 = UtilImageIO.loadImage(directory + "object4.png", ImageFloat32.class);
...
public class ExampleTemplateMatching {
	...
	public static void main(String args[]) {
		...
		ImageFloat32 image = UtilImageIO.loadImage("WillyTest1.png", ImageFloat32.class);
		//ImageFloat32 templateX = UtilImageIO.loadImage(directory + "x.png", ImageFloat32.class);
		ImageFloat32 templatePaint = UtilImageIO.loadImage("Willy1PatternS.png", ImageFloat32.class);
